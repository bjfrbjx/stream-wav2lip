...
class SyncNet_color_96(nn.Module):
    def __init__(self):
        super(SyncNet_color_96, self).__init__()
...
class SyncNet_color_144(nn.Module):
    def __init__(self):
        super(SyncNet_color_144, self).__init__()
...
class SyncNet_color_288(nn.Module):
    def __init__(self):
        super(SyncNet_color_288, self).__init__()
        ...
        self.face_encoder = nn.Sequential(
            ...
            Conv2d(32, 64, kernel_size=5, stride=2, padding=1, act="leaky"),
            Conv2d(64, 64, kernel_size=3, stride=1, padding=1, residual=True, act="leaky"),
            Conv2d(64, 64, kernel_size=3, stride=1, padding=1, residual=True, act="leaky"),
