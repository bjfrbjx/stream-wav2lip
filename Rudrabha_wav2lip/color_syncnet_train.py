...
from trains import Sync_Dataset, syncnet_train, load_checkpoint
...
if __name__ == "__main__":
    ...
    train_dataset = Sync_Dataset(f"{args.data_root}/train.txt",img_size)
    test_dataset = Sync_Dataset(f"{args.data_root}/val.txt",img_size)
